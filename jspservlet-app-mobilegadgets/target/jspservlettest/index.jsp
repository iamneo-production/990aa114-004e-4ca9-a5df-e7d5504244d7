<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    %>
<%@ page import="java.util.*,model.*,model.*" %>	
...
<html>
    ...
    <table>
        ...
        <td><div class="content1" id="left">
            <%
            List<Gadgets> theList = (List<Gadgets>)request.getAttribute("list");
            %>
            ...
            <tbody>
                <% for(Gadgets m:theList){%>
                    <tr>
                        ...
                        <td>
                           <%=m.getquantity()%>
                           &nbsp;&nbsp;&nbsp;<a href="edit?id=<c:out value='$(gadget.gadgetId)'/>">EDIT</a>
                           &nbsp;&nbsp;&nbsp;<a href="delete?id=<c:out value='$(gadget.gadgetId)'/>">DELETE</a>  
                        </td>
                    </tr>
	    ...
	    <form action="<%= request.getContextPath()%>"/add method="GET" id="add">
